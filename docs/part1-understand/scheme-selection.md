...
- [FHE Scheme Comparison（fhetextbook.github.io）](https://fhetextbook.github.io/FHESchemeComparisonandSummary.html) —— 各 Scheme 的数学层面对比表
- [A High-Level Technical Overview of FHE（Jeremy Kun）](https://www.jeremykun.com/2024/05/04/fhe-overview/) —— 工程师视角的深度综述
- [OpenFHE 文档](https://openfhe-development.readthedocs.io/) —— 支持所有主流 Scheme 的参考实现